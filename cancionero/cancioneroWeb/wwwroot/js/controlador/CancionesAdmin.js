...
export default {
    ...
    methods: {
        ...
        borrarCancion(index) {
            ...
            localStorage.setItem('misCanciones', JSON.stringify(this.cancionesLocales));
        },
        agregarCancion(index) {
            const nuevaCancion = this.cancionesFiltradas[index];
        ...
        calcularCancionesFiltradas() {
            ...
            while ((count < this.cancionesRemotas.length) && (this.cancionesFiltradas.length < 20))
            {
                var agregar = true;
    ...
    mounted() {
        ...
        // Carga los filtros
        this.filtroTono = helperMusica.nuevanota("");
        this.filtroAcorde = helperMusica.nuevanota("");
    },
